...
$cookie_item8 = "Item8count";
if (!isset($_COOKIE['Item8count'])) {
setcookie($cookie_item8,0, time() + (7200),"/");
}
else{
setcookie($cookie_item8,$_COOKIE["Item8count"]+1, time() + (7200),"/");
}
 ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Neil Trestle Dining Table</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>Neil Trestle Dining Table</h1>
					<h4>Description</h4>
					<p>
Made from a blend of solid and manufactured wood, this table has a trestle base with two angled supports, and showcases a moderate distressed carbon coloring for a touch of rustic appeal in your abode. The rectangular tabletop features two square accents etched into the wood, and accommodates up to six people comfortably.<h4>Warranty</h4>
					<p>
	 ...
	 <input type="hidden" id="prodname" name="prodname" value="Neil Trestle Dining Table">
