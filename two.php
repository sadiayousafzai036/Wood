...
$cookie_item2 = "Item2count";
if (!isset($_COOKIE['Item2count'])) {
setcookie($cookie_item2,0, time() + (7200),"/");
}
else{
setcookie($cookie_item2,$_COOKIE["Item2count"]+1, time() + (7200),"/");
}
 ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Cushioned Sofa in Cashmere</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>Cushioned Sofa in Cashmere</h1>
					<h4>Description</h4>
					<p>
						This 3 cushion couch cover could help protect your couch from the daily tear, spills, stains and so on. It is a great choice for homes with children and pets, or if you just want a fresh new look for your sofa. The stretchy fabric and separate cushion cover design create a clean crisp look and slip-resistant. <h4>Warranty</h4>
...
<form id="myform" action="product_rating.php" method="post">
	 <input type="hidden" id="prodname" name="prodname" value="Cushioned Sofa in Cashmere">
