...
<body>
	...
	<div id="contents">
		<div>
            ...
            $encoded_name = urlencode("Madeline Dining Table");
   	 $encoded_url = urlencode("https://sadiayousafzai2.herokuapp.com/five.php");
   	 $redirect_url = "http://ganesh041152080.ipage.com/marketplace/cookie_setter.php?name=".$encoded_name."&url=".$encoded_url;
    echo "<h5><a href=".$redirect_url.">Madeline Dining Table</a></h5>";    
?>
						<p>
							It’s a perfect pick for apartments, townhouses, and other diminutive ensembles.
						</p>
						<div class="details">
							<h5>Details</h5>
							<p>
								<b>Measurements:</b> 48" x 32" x 30"
							</p>
							<p>
								<b>Weight:</b> 100 lbs.
							</p>
					...
					<li>
						...
						<?php
            $encoded_name = urlencode("Goodyear Solid Wood Dining Table");
   	 $encoded_url = urlencode("https://sadiayousafzai2.herokuapp.com/six.php");
   	 $redirect_url = "http://ganesh041152080.ipage.com/marketplace/cookie_setter.php?name=".$encoded_name."&url=".$encoded_url;
    echo "<h5><a href=".$redirect_url.">Goodyear Solid Wood Dining Table</a></h5>";    
?>
						<p>
							The heart of your entertaining ensemble is your dining table.</p>
						<div class="details">
							<h5>Details</h5>
							<p>
								<b>Measurements:</b> 29" x 47.2" x 29.5"
							</p>
							<p>
								<b>Weight:</b> 120 lbs.
							</p>
