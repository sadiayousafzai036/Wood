...
<head>
	<meta charset="UTF-8">
	<title>Treated Oak Flooring with wide Table and Bench</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>Treated Oak Flooring with wide Table and Bench</h1>
					<h4>Description</h4>
					<p>
						Signature Series Bench/Table Combos come in either a 6' or 8' portable option. Use it as a Bench or if a Table is needed, simply convert the seat back to the vertical position for Table. The seat is 10" wide while the back is 15" wide.
						<h4>Warranty</h4>
					<p>
