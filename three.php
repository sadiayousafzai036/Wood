...
$cookie_item3 = "Item3count";
if (!isset($_COOKIE['Item3count'])) {
setcookie($cookie_item3,0, time() + (7200),"/");
}
else{
setcookie($cookie_item3,$_COOKIE["Item3count"]+1, time() + (7200),"/");
}
 ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>McKenly Modern 69.7" Square Arm Sofa</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>McKenly Modern 69.7" Square Arm Sofa</h1>
					<h4>Description</h4>
					<p>
						Crafted from solid and manufactured wood, it stands atop splayed legs and features a streamlined silhouette wrapped in linen upholstery. Coil springs in the seats pair with foam fill to offer you comfort as you kick back with your latest read or lounge with friends.
						<h4>Warranty</h4><p>
...
<form id="myform" action="product_rating.php" method="post">
	 <input type="hidden" id="prodname" name="prodname" value="McKenly Modern 69.7(in) Square Arm Sofa<">
