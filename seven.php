...
$cookie_item7 = "Item7count";
if (!isset($_COOKIE['Item7count'])) {
setcookie($cookie_item7,0, time() + (7200),"/");
}
else{
setcookie($cookie_item7,$_COOKIE["Item7count"]+1, time() + (7200),"/");
}
 ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Belynda White Faux Marble Table Top Dining Table</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>Belynda White Faux Marble Table Top Dining Table</h1>
					<h4>Description</h4>
					<p>
This anti-scratch faux carrara marble table is the perfect fit for a party of two. But if Monopoly Deal breaks lose, feel free to pull up another 2 seats. The table base is equipped with a weight in the base making the dreaded wobble table a thing of the past.
<h4>Warranty</h4>
					<p>
	 ...
	 <input type="hidden" id="prodname" name="prodname" value="Belynda White Faux Marble Table Top Dining Table">
