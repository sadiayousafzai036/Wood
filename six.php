...
$cookie_item6 = "Item6count";
if (!isset($_COOKIE['Item6count'])) {
setcookie($cookie_item6,0, time() + (7200),"/");
}
else{
setcookie($cookie_item6,$_COOKIE["Item6count"]+1, time() + (7200),"/");
}
 ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Goodyear Solid Wood Dining Table</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>Goodyear Solid Wood Dining Table</h1>
					<h4>Description</h4>
					<p>
Anchor an entertaining area, spruce up a breakfast nook, or set the foundation for a small-scale home office with this versatile table! It is metal base pairs with a manufactured wood top for a rustic look that leans into modern influences, while rivet details add a touch of textural and industrial appeal. Seats up to four comfortably.<h4>Warranty</h4>
	 ...
	 <input type="hidden" id="prodname" name="prodname" value="Goodyear Solid Wood Dining Table">
