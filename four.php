...
$cookie_item4 = "Item4count";
if (!isset($_COOKIE['Item4count'])) {
setcookie($cookie_item4,0, time() + (7200),"/");
}
else{
setcookie($cookie_item4,$_COOKIE["Item4count"]+1, time() + (7200),"/");
}
 ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>Lambdin Wooden Sofa</title>
...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span>
				...
				<div id="main">
					<h1>Lambdin Wooden Sofa</h1>
					<h4>Description</h4>
					<p>
						This Lambdin Wooden Sofa has a button tufted fabric back design for a traditional home. Accent pillows included. Thanks to the sturdy frame, this sofa is strong and durable. With the loose seat cushion, it will ensure that you enjoy a comfortable seating experience as always. <p>
						<h4>Warranty</h4>
...
<form id="myform" action="product_rating.php" method="post">
	 <input type="hidden" id="prodname" name="prodname" value="Lambdin Wooden Sofa">
