					...
					<li>
						<div class="frame">
							<img src="images/33.jpg" alt="Img">
												...
												<?php
            $encoded_name = urlencode("Oak Wood Padded Folding Chair");
   	 $encoded_url = urlencode("https://sadiayousafzai2.herokuapp.com/nine.php");
   	 $redirect_url = "http://ganesh041152080.ipage.com/marketplace/cookie_setter.php?name=".$encoded_name."&url=".$encoded_url;
    echo "<h5><a href=".$redirect_url.">Oak Wood Padded Folding Chair</a></h5>";    
?>
						<p>
							This folding chair has an upholstered seat of vinyl or fabric.
						</p>
						<div class="details">
							<h5>Details</h5>
							<p>
								<b>Measurements:</b> 30.5" x 17.25" x 16.25"
							</p>
							<p>
								<b>Weight:</b> 110 lbs.
							</p>
					...
					<li>
						<div class="frame">
							<img src="images/37.jpg" alt="Img">
						</div>				<?php
            $encoded_name = urlencode("Cheryll Solid Wood Cross back Side chair");
   	 $encoded_url = urlencode("https://sadiayousafzai2.herokuapp.com/ten.php");
   	 $redirect_url = "http://ganesh041152080.ipage.com/marketplace/cookie_setter.php?name=".$encoded_name."&url=".$encoded_url;
    echo "<h5><a href=".$redirect_url.">Cheryll Solid Wood Cross back Side chair</a></h5>";    
?>
						<p>
							The ultimate compliment to your dining ensemble.</p>
						<div class="details">
							<h5>Details</h5>
							<p>
								<b>Measurements:</b> 39.75" x 17.5" x 22.75"
							</p>
							<p>
								<b>Weight:</b> 90 lbs.
							</p>
