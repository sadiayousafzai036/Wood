		...
		<div>
			<div class="body"  id="gallery">
				...
				<ul class="items">
					<li>
						<div class="frame">
							<img src="images/25.jpg" alt="Img">
						</div>
						
								<?php
            $encoded_name = urlencode("Belynda White Faux Marble Table Top Dining Table");
   	 $encoded_url = urlencode("https://sadiayousafzai2.herokuapp.com/seven.php");
   	 $redirect_url = "http://ganesh041152080.ipage.com/marketplace/cookie_setter.php?name=".$encoded_name."&url=".$encoded_url;
    echo "<h5><a href=".$redirect_url.">Belynda White Faux Marble Table Top Dining Table</a></h5>";    
?>
						<p>
							Designed for small dining areas to make you feel like you're in a Paris cafe!
						</p>
						<div class="details">
							<h5>Details</h5>
							<p>
								<b>Measurements:</b>  31" x 31" x 29"
							</p>
							<p>
								<b>Weight:</b> 123 lbs.
							</p>
					...
					<li>
						<div class="frame">
							<img src="images/29.jpg" alt="Img">
														...
														<?php
            $encoded_name = urlencode("Neil Trestle Dining Table");
   	 $encoded_url = urlencode("https://sadiayousafzai2.herokuapp.com/eight.php");
   	 $redirect_url = "http://ganesh041152080.ipage.com/marketplace/cookie_setter.php?name=".$encoded_name."&url=".$encoded_url;
    echo "<h5><a href=".$redirect_url.">Neil Trestle Dining Table</a></h5>";    
?>
						<p>
							Offer the charm of modern farmhouse-inspired style to your dining room with this attention-grabbing table.</p>
						<div class="details">
							<h5>Details</h5>
							<p>
								<b>Measurements:</b> 60" x 30" x 30"
							</p>
							<p>
								<b>Weight:</b> 250 lbs.
							</p>
				...
				<div id="pagination">
					<ul>
						...
						<li>
							<a href="tables.php">1</a>
						</li>
						<li class="selected">
							<a href="tables1.php">2</a>
						</li>
					</ul>
				</div>
			</div>
